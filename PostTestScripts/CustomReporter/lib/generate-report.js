...
const DEFAULT_REPORT_NAME = 'Post Test Reports';
...
function generateReport(options) {
  ...
  // const fileName = options.fileName || INDEX_HTML; // custom added option
  ...
  if (!disableLog) {
    console.log(
        ...
        `\n
=====================================================================================
    Custom DTIC HTML Test Report Generated In:
      ...
      if (
        ...
        fs.copySync(
          path.resolve(
            ...
            'PostTestScripts/CustomReporter/templates/assets'
          ),
